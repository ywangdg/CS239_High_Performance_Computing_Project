...
dnl
dnl Generated by mpiteam at Tue Nov  7 18:28:44 2017
dnl on aws.open-mpi.org.
dnl ---------------------------------------------------------------------------
...
m4_define([mca_opal_common_m4_config_component_list], [verbs_usnic, verbs, sm, libfabric, cuda, ugni])
...
m4_define([mca_opal_backtrace_m4_config_component_list], [none, printstack, execinfo])
m4_define([mca_opal_backtrace_no_config_component_list], [])

dnl Components in the opal / btl framework
m4_define([mca_opal_btl_m4_config_component_list], [smcuda, tcp, portals4, sm, scif, ugni, vader, usnic, openib])
...
m4_define([mca_opal_event_m4_config_component_list], [libevent2022, external])
...
m4_define([mca_opal_if_m4_config_component_list], [solaris_ipv6, posix_ipv4, bsdx_ipv4, linux_ipv6, bsdx_ipv6])
...
m4_define([mca_opal_mpool_m4_config_component_list], [rgpusm, udreg, gpusm])
...
m4_define([mca_opal_pmix_m4_config_component_list], [cray, s2, external, s1, pmix112])
...
m4_define([mca_opal_sec_m4_config_component_list], [munge, keystone])
m4_define([mca_opal_sec_no_config_component_list], [basic])

dnl Components in the opal / shmem framework
m4_define([mca_opal_shmem_m4_config_component_list], [posix, sysv, mmap])
m4_define([mca_opal_shmem_no_config_component_list], [])

dnl Components in the opal / timer framework
m4_define([mca_opal_timer_m4_config_component_list], [darwin, altix, linux, solaris])
...
m4_define([mca_orte_dfs_no_config_component_list], [app, test, orted])

dnl Components in the orte / errmgr framework
m4_define([mca_orte_errmgr_m4_config_component_list], [])
m4_define([mca_orte_errmgr_no_config_component_list], [default_orted, default_app, default_hnp, default_tool])

dnl Components in the orte / ess framework
m4_define([mca_orte_ess_m4_config_component_list], [slurm, alps, lsf, tm])
m4_define([mca_orte_ess_no_config_component_list], [singleton, tool, hnp, pmi, env])
...
m4_define([mca_orte_iof_no_config_component_list], [mr_orted, tool, mr_hnp, hnp, orted])
...
m4_define([mca_orte_oob_m4_config_component_list], [usock, tcp, ud, alps])
m4_define([mca_orte_oob_no_config_component_list], [])

dnl Components in the orte / plm framework
m4_define([mca_orte_plm_m4_config_component_list], [slurm, rsh, isolated, alps, lsf, tm])
m4_define([mca_orte_plm_no_config_component_list], [])

dnl Components in the orte / ras framework
m4_define([mca_orte_ras_m4_config_component_list], [slurm, gridengine, alps, loadleveler, lsf, tm])
...
m4_define([mca_orte_rmaps_no_config_component_list], [round_robin, ppr, resilient, seq, mindist, rank_file, staged])
...
m4_define([mca_orte_state_no_config_component_list], [app, tool, dvm, novm, hnp, orted, staged_orted, staged_hnp])
...
m4_define([mca_ompi_coll_m4_config_component_list], [fca, portals4, cuda, hcoll])
m4_define([mca_ompi_coll_no_config_component_list], [libnbc, inter, sync, basic, sm, self, tuned])

dnl Components in the ompi / fbtl framework
m4_define([mca_ompi_fbtl_m4_config_component_list], [posix, plfs, pvfs2])
...
m4_define([mca_ompi_fcoll_no_config_component_list], [two_phase, dynamic, individual, static])

dnl Components in the ompi / fs framework
m4_define([mca_ompi_fs_m4_config_component_list], [plfs, pvfs2, lustre])
...
m4_define([mca_ompi_mtl_m4_config_component_list], [psm2, psm, ofi, portals4, mxm])
...
m4_define([mca_ompi_osc_m4_config_component_list], [rdma, portals4, pt2pt])
m4_define([mca_ompi_osc_no_config_component_list], [sm])

dnl Components in the ompi / pml framework
m4_define([mca_ompi_pml_m4_config_component_list], [v, ucx, yalla, ob1])
...
m4_define([mca_ompi_sharedfp_no_config_component_list], [lockedfile, individual])
...
m4_define([mca_oshmem_atomic_m4_config_component_list], [ucx, mxm])
...
m4_define([mca_oshmem_scoll_no_config_component_list], [mpi, basic])

dnl Components in the oshmem / spml framework
m4_define([mca_oshmem_spml_m4_config_component_list], [ucx, ikrit])
m4_define([mca_oshmem_spml_no_config_component_list], [yoda])

dnl Components in the oshmem / sshmem framework
m4_define([mca_oshmem_sshmem_m4_config_component_list], [sysv, verbs, mmap])
...
m4_define([ompi_mpiext_list], [affinity, cuda])
