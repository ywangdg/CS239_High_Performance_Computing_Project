...
/* Define to 1 if you have the <pmix.h> header file. */
/* #undef HAVE_PMIX_H */
...
/* Version of hwloc */
#define HWLOC_HWLOC1112_HWLOC_VERSION "internal v1.11.2"
...
#define HWLOC_SYM_PREFIX opal_hwloc1112_

/* The hwloc symbol prefix in all caps */
#define HWLOC_SYM_PREFIX_CAPS OPAL_HWLOC1112_
...
#define MCA_hwloc_IMPLEMENTATION_HEADER "opal/mca/hwloc/hwloc1112/hwloc1112.h"
...
#define MCA_io_romio314_COMPLETE_CONFIGURE_FLAGS " FROM_OMPI=yes CC='gcc' CFLAGS='-O3 -DNDEBUG -finline-functions -fno-strict-aliasing  -D__EXTENSIONS__' CPPFLAGS='  -I/Users/carolynyen/Downloads/gamelife/CS239_High_Performance_Computing_Project/openmpi-2.0.4/opal/mca/hwloc/hwloc1112/hwloc/include -I/Users/carolynyen/Downloads/gamelife/CS239_High_Performance_Computing_Project/openmpi-2.0.4/opal/mca/event/libevent2022/libevent -I/Users/carolynyen/Downloads/gamelife/CS239_High_Performance_Computing_Project/openmpi-2.0.4/opal/mca/event/libevent2022/libevent/include' FFLAGS='' LDFLAGS=' -Wl,-flat_namespace ' --enable-shared --disable-static  --prefix=/Users/carolynyen/opt/usr/local --disable-aio --disable-weak-symbols --enable-strict"

/* Set of user-defined configure flags given to ROMIOs configure script via
   --with-io-romio-flags */
#define MCA_io_romio314_USER_CONFIGURE_FLAGS ""
...
#define MEMORY_LINUX_HAVE_MALLOC_HOOK_SUPPORT 0

/* Whether the memory linux malloc alignment is enabled */
#define MEMORY_LINUX_MALLOC_ALIGN_ENABLED 0
...
#define OMPI_MPIEXT_COMPONENTS "affinity, cuda"
...
#define OMPI_TARBALL_VERSION "2.0.4"
...
#define OPAL_ARCH "x86_64-apple-darwin18.7.0"
...
#define OPAL_IDENT_STRING "2.0.4"
...
#define OPAL_PACKAGE_STRING "Open MPI carolynyen@s-164-67-226-70.resnet.ucla.edu Distribution"
...
#define OPAL_RELEASE_DATE "Nov 07, 2017"
...
#define OPAL_REPO_REV "v2.0.3-102-gdb3ffbe"
...
#define OPAL_TARBALL_VERSION "2.0.4"
...
#define ORTE_RELEASE_DATE "Nov 07, 2017"
...
#define ORTE_REPO_REV "v2.0.3-102-gdb3ffbe"

/* Tarball filename version string of Open MPI Run-Time Environment */
#define ORTE_TARBALL_VERSION "2.0.4"
...
#define OSHMEM_TARBALL_VERSION "2.0.4"
...
#define PACKAGE_STRING "Open MPI 2.0.4"
